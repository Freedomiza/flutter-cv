            ...
            WorkSection(
              ...
              workDetails: [
                SkillSection(
                  ...
                  details: "Bachelor of Information Technology•April 2013",
                )
              ],
            ),
            WorkSection(
                ...
                SkillSection(
                  ...
                  extendedDetails: Column(
                    ...
                    children: [
                      ...
                      RichText(
                          text: TextSpan(
                        text: "Technology: php, React + Nextjs, Redux, Antd\n",
                        style: kBodyTextStyleDark,
                      )),
                      RichText(
                          text: TextSpan(
                ...
                SkillSection(
                  ...
                  extendedDetails: Column(
                    ...
                    children: [
                      ...
                      RichText(
                          text: TextSpan(
                        text: "Senior React Frontend December 2019 - Present\n",
                        style: kBodyTextStyleDark,
                      )),
                      RichText(
                          text: TextSpan(
                      ...
                      RichText(
                        ...
                        recognizer: new TapGestureRecognizer()
                          ..onTap = () {
                            // launch('skype://freedom_iza');
                            js.context.callMethod(
                                "open", ["https://www.restorationai.com/"]);
                          },
                      )),
                    ],
                  ),
                      ...
                      RichText(
                        ...
                        recognizer: new TapGestureRecognizer()
                          ..onTap = () {
                            // launch('skype://freedom_iza');
                            js.context.callMethod(
                                "open", ["https://webox-212807.appspot.com/"]);
                          },
                      )),
                    ],
                  ),
